...
void print_ncurses_game(room_t room, question_t question, deck_t deck, player_t player)
{
    int i, j;
    ...
    */
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        if (!strcmp(room.players[i].nickname, player.nickname))
        {
        ...
        if (!strcmp(room.players[i].nickname, room.host.nickname))
        {
